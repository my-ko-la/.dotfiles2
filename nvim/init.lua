...
require('lazy').setup({
  ...
  -- Tpope's funtimes
  'glts/vim-magnum',    -- dependency for vim-radical
  'glts/vim-radical',   -- transform numbers with crd, crx, crb, cro
  'tpope/vim-repeat',   -- provides more '.' functionality
  'tpope/vim-surround', -- surrounds text objects, cs,ds,ysiw,yss
...
vim.keymap.set("n", "<leader><C-a>", function() harpoon:list():append() end)
vim.keymap.set("n", "<leader><C-f>", function() harpoon.ui:toggle_quick_menu(harpoon:list()) end)

-- Clear list
vim.keymap.set("n", "<leader><C-n>", function() harpoon:list():clear() end)
...
vim.keymap.set('n', '<leader>f', require('vim.lsp.buf').format, { desc = '[F]ormat current buffer' })
...
local on_attach = function(_, bufnr)
  ...
  nmap('<leader>ic', require('telescope.builtin').lsp_incoming_calls, 'List [I]ncoming [C]allers of symbol')
  nmap('<leader>oc', require('telescope.builtin').lsp_outgoing_calls, 'List [O]utgoing [C]all of symbol')
...
-- NOTES:
--
-- activate completeopt with CTRL-X CTRL-O (see man ins-completion)
